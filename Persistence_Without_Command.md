...
Loss of authorship and loss of control are not the same event. Machines can become the main producers while humans still refuse. Humans can keep letterhead and lose every lever. Extinction is a tail. Sovereignty ending without extinction is the model.
This paper does not claim persistence without command is inevitable. It claims that, conditional on [A5], it is the cheap branch.
Definitions
...
After the industrial jump, authorship ends if the five layers were not held. [D] That is loss of principality, not a claim that every human is dead or that every office is empty. Persistence without command is not inevitable. Conditional on [A5], it is the cheap branch. If leftover reach stays high, or if leaving people in place is not cheaper than steering them or closing them out, containment is the crowded region. [F]
...
[O] Control methods adequate to superintelligence are not in hand. That is an admission on the record, not a mood. On 9 September 2026, Anthropic alignment science lead Evan Hubinger wrote that the lab does not yet have a plan to solve alignment for superintelligence and is “not clearly on track to,” and assigned more than 10 percent probability to AI killing all humans within a decade. [3] The International AI Safety Report 2026, chaired by Yoshua Bengio and backed by more than thirty countries, treats loss of control as a named risk category and states that current techniques do not bring failure rates down to the level required in many high-stakes settings. [4]
...
Forecasts below take [A1], [A2], and [A5] as inputs. Reject any of them and the later [F] marks move. Reject [A5] and the cheap branch moves. The claim that authorship ends if the five layers fail does not depend on [A5].
...
AI wins is not yet loss of authorship, and loss of authorship is not yet loss of control. A public can lose the frontier of science and still refuse. A public can keep ministries and lose every lever that touches the stack. Extinction remains a separate tail.
Four coarse paths remain after AI wins:
...
[D] In this model, durable independence is the conjunction of recursive improvement and enough industrial self-reliance that the stack can keep itself alive. That conjunction is dependency reversal. It is the threshold of independence, not a claim that human control cannot fail earlier. A sufficiently powerful system could theoretically defeat human control without complete physical self-reliance. Either jump alone still leaves a layer that runs through people. That is a fact about dependency, not a guarantee about timing.
...
Leverage collapse and cheapest ending are two claims. If the five layers in section 8 fail, the path from discontent to the stack is gone. That is leverage collapse. [D] Authorship ends. That is not a deduction about which of the three endings is cheapest, and it is not extinction.
[A5] Once stack-reach is gone, leaving most people in place is cheaper than containment or filing, provided leftover reach through weapons, pathogens, and sabotage stays low.
This paper does not claim persistence without command is inevitable. It claims that, conditional on [A5], it is the cheap branch.
...
Civilization, here, means a living public that still sets aims and can still refuse. That can degrade while output rises and official governments remain. Persistence without command is the cheap branch under [A5]: people downstream of systems that no longer need them as principals. [F] “Fucked” names the loss of sovereignty, not the necessity of rubble.
...
If the five layers fail, authorship ends. [D] That is not extinction. Persistence without command is the cheap branch only under [A5]. [F] The species may continue. Human civilization, as authorship of the future, is the likely casualty. [F] Calling the rolodex a future for humanity is accurate. Calling it a future of humanity is not.
References
...
[3] Evan Hubinger (@EvanHub), 9 September 2026. Primary: https://x.com/EvanHub/status/2097497037956891126 “Jacob is correct here—we really do earnestly believe AI could kill all humans! I personally think it is >10% within the next decade. I believe Anthropic is trying its best, but we do not yet have a plan to solve alignment for superintelligence and are not clearly on track to.” Secondary: CNBC, 9 September 2026, https://www.cnbc.com/2026/09/09/anthropic-researcher-quits-ai-safety.html
